...
outfile = "CS"+str(casenumber)+"PythonMaxZ"+str(brad)+".csv"
...
CIndex = {}
xindices = prob.variables.add(names = ["x"+str(i) for i in range(numvars+m+1)])  ### XQ+Xq, first n^2 terms part of XQ, last Xq
...
if z >= -0.00001:
	print "Initial ceps of ", ceps, " is too large."
	quit()
