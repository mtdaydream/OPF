\section{Numerical studies} \label{sec:numstud}
...
$x=\left(Re(V_1), \dots, Re(V_n), Im(V_1),\dots , Im(V_n)\right)$ and $u=\left(p_1, \dots, p_n, q_1, \dots, q_n, v_1, \dots, v_n\right)$ assuming. 
