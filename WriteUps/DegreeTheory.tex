...
\begin{document}
\begin{center}
\textbf{\modified{To What Degree Can We Use Degree?}} % Theory Blog}
\end{center}
...
\medskip
\add{To keep the discussion simple,} %In this post
